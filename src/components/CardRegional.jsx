...
const CardRegional = ({arrayItemEstado}) => {
    console.log(arrayItemEstado)

    return (
        <CardsContainer>
            {/* {arrayItemEstado.map((empreedimento, index) => (
                <div key={index}>
                    <p>{empreedimento.name}</p>
                </div>
            ))} */}
            <section>
                {arrayItemEstado.map((card) => (
                    <div className='div-card' key={card.id}>
                        ...
                        <div className='div-details-web'>
                            ...
                            <Link to={'/' + card.category + '/' + card.name.toLowerCase().replace(/ /g, "-")} id='conhecer-imovel-web' href="">CONHECER IMÓVEL</Link>
                        </div>
                        <Link to={'/' + card.category + '/'+ card.name.toLowerCase().replace(/ /g, "-")} id='conhecer-imovel-mobile' href="">CONHECER IMÓVEL</Link>
                    </div>
                ))}
            </section>
        </CardsContainer>
